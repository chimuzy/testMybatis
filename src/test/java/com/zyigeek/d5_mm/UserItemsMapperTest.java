...
public class UserItemsMapperTest {
    ...
    public void find() {
        ...
        //detailList=[OrderdetailCustom{itemsCustom=Items{id=1, name='台式机', price=3000.0, detail='该电脑质量非常好！！！！', createtime=2015-02-03 13:22:53.0, pic='null'}},
        ...
        //detailList=[OrderdetailCustom{itemsCustom=Items{id=3, name='背包', price=200.0, detail='名牌背包，容量大质量好！！！！', createtime=2015-02-06 13:23:02.0, pic='null'}},
        //OrderdetailCustom{itemsCustom=Items{id=2, name='笔记本', price=6000.0, detail='笔记本性能好，质量好！！！！！', createtime=2015-02-09 13:22:57.0, pic='null'}}]}]}
    }
}
